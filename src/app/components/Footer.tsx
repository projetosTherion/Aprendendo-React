...
export function Footer(){
    ...
    <img src = "/album.jpg" width ={56} height = {56} alt = "Capa do álbum HIT ME HARD AND SOFT de Billie Eilish"></img>
      <div className ="flex flex-col">
        <strong className = "font-regular">Chihiro</strong>
    ...
    <div className = "flex flex-col items-center">
      ...
      <div className = "flex items-center gap-2 mt-2">
        ...
        <span className = "text-xs text-zinc-400">5:04</span>
      </div>   
      </div>
